...
public class Effects : NetworkBehaviour {
    ...
    public void RpcSparky(Vector3 pos1, Vector3 pos2, string sound, string hitSound)
    {
        ...
        StartCoroutine(SparkyIE(pos1, pos2));
    }

    public void Sparky(Vector3 pos1, Vector3 pos2, string sound, string hitSound)
    {
    ...
    IEnumerator SparkyIE(Vector3 pos1, Vector3 pos2)
    {
